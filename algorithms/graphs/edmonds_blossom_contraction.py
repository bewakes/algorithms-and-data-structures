...
'''
this program calculates the maximal matching in general graph
Implementation of Edmonds blossom contraction algorithm
Reference: Wikipedia : https://en.wikipedia.org/wiki/Blossom_algorithm
Source: https://gist.github.com/rogerhub/8343103 [Modified code for constructing the longest augmented path]
'''
            ...
            if w_tree is None:
                ...
                if w_tree.height() % 2 == 1:
                    ...
                    if v_root != w_root:
                        ...
                        matching_clone.__class__ = Matching
